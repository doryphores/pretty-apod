...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('apod_photo', 'original_image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.original_image'
        db.delete_column('apod_photo', 'original_image')
